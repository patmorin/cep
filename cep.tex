...
% \gwen{Aren't we off by some radius $R$ here? $C$ contains a vertex in $B_G(\widehat{Y},R)$, but not necessarily in $\widehat{Y}$ itself. Should we change $g(d)$ to $g(d)=13d+R=19d$?}\pat{I agree, and will fix shortly.}
