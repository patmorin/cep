...
\begin{frame}
  ...
  \only<8>{\includegraphics[page=8]{figs/animation}}%
  \only<9>{\includegraphics[page=9]{figs/animation}}%
  \only<10>{\includegraphics[page=10]{figs/animation}}%
  \only<11>{\includegraphics[page=11]{figs/animation}}%
  ...
  \only<+>{\textbf{Lemma:} For each $i\in\{1,\ldots,p\}$,  $B_G(C_i,6d)-B_G(X_i,13d)$ is acyclic, for some $X_i$ with $|X_i|\le f'(k)$}%
  \only<+>{\textbf{Lemma:} For each $i\in\{1,\ldots,p\}$,  $B_G(C_i,6d)-B_G(X_i,13d)$ is acyclic, for some $X_i$ with $|X_i|\le f'(k)$}%
  \only<+>{\textbf{Lemma:} For each $i\in\{1,\ldots,p\}$,  $B_G(C_i,6d)-B_G(X_i,13d)$ is acyclic, for some $X_i$ with $|X_i|\le f'(k)$}%
  \only<+>{\textbf{Lemma:} For each $i\in\{1,\ldots,p\}$,  $B_G(C_i,6d)-B_G(X_i,13d)$ is acyclic, for some $X_i$ with $|X_i|\le f'(k)$}%
